...
export default function TabsProductList(props: TabsProductListProps) {
        ...
        <div className='w-full'>
            <Box sx={{ width: '100%' }}>
                ...
                <div className='flex flex-row'>
                    <div>
                        <Image width={232} height={542} src={'https://www.waveshare.net/photo/column/AI/1.jpg'} alt={''}></Image>
                    </div>
